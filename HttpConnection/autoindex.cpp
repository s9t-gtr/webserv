...
// std::string HttpConnection::createAutoindexPage(Request& requestInfo){
//     std::string content;
//     content = "<html>\n";
//     content += "<head>\n";
...
// void HttpConnection::sendAutoindexPage(Request& requestInfo, progressInfo *obj)
// {
