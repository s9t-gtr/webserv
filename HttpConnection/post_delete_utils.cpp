...
// void HttpConnection::sendInternalErrorPage(progressInfo *obj)
// {
...
// void HttpConnection::executeCgi_postVersion(Request& requestInfo, int pipe_c2p[2])
// {
//     close(pipe_c2p[R]);
//     dup2(pipe_c2p[W],1);
//     close(pipe_c2p[W]);
...
// void HttpConnection::postProcess(Request& requestInfo, progressInfo *obj)
// {
...
// void HttpConnection::deleteProcess(progressInfo *obj)
// {
